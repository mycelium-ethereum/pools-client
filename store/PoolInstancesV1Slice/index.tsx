...
import { IPoolsInstancesV1Slice } from './types';
import { StoreState } from '..';

export const createPoolsInstancesSlice: StateSlice<IPoolsInstancesV1Slice> = (set, get) => ({
    pools: {},
...
export const selectSelectedPool: (state: StoreState) => IPoolsInstancesV1Slice['selectedPool'] = (state) =>
    state.poolsInstancesSlice.selectedPool;
export const selectPoolInstances: (state: StoreState) => IPoolsInstancesV1Slice['pools'] = (state) =>
    state.poolsInstancesSlice.pools;
export const selectPoolsInitialized: (state: StoreState) => IPoolsInstancesV1Slice['poolsInitialized'] = (state) =>
    state.poolsInstancesSlice.poolsInitialized;
export const selectPoolsInitializationError: (state: StoreState) => IPoolsInstancesV1Slice['poolsInitializationError'] = (
    state,
) => state.poolsInstancesSlice.poolsInitializationError;

export const selectPoolInstanceActions: (state: StoreState) => {
    setPool: IPoolsInstancesV1Slice['setPool'];
    setMultiplePools: IPoolsInstancesV1Slice['setMultiplePools'];
    resetPools: IPoolsInstancesV1Slice['resetPools'];
    setPoolsInitialized: IPoolsInstancesV1Slice['setPoolsInitialized'];
    setPoolsInitializationError: IPoolsInstancesV1Slice['setPoolsInitializationError'];
    setTokenBalances: IPoolsInstancesV1Slice['setTokenBalances'];
    setTokenApprovals: IPoolsInstancesV1Slice['setTokenApprovals'];
    setAggregateBalances: IPoolsInstancesV1Slice['setAggregateBalances'];
    setPoolIsWaiting: IPoolsInstancesV1Slice['setPoolIsWaiting'];
    setPoolExpectedExecution: IPoolsInstancesV1Slice['setPoolExpectedExecution'];
    setTokenApproved: IPoolsInstancesV1Slice['setTokenApproved'];
} = (state) => ({
...
export const selectPoolInstanceUpdateActions: (state: StoreState) => {
    handlePoolUpkeep: IPoolsInstancesV1Slice['handlePoolUpkeep'];
    updatePoolBalances: IPoolsInstancesV1Slice['updatePoolBalances'];
    updatePoolTokenBalances: IPoolsInstancesV1Slice['updatePoolTokenBalances'];
    updateSettlementTokenBalances: IPoolsInstancesV1Slice['updateSettlementTokenBalances'];
    updateTokenApprovals: IPoolsInstancesV1Slice['updateTokenApprovals'];
    updateOracleDetails: IPoolsInstancesV1Slice['updateOracleDetails'];
    updateTradeStats: IPoolsInstancesV1Slice['updateTradeStats'];
    updateNextPoolStates: IPoolsInstancesV1Slice['updateNextPoolStates'];
    updatePoolCommitStats: IPoolsInstancesV1Slice['updatePoolCommitStats'];
    updatePoolBalancerPrices: IPoolsInstancesV1Slice['updatePoolBalancerPrices'];
    simulateUpdateAvgEntryPrices: IPoolsInstancesV1Slice['simulateUpdateAvgEntryPrices'];
} = (state) => ({
