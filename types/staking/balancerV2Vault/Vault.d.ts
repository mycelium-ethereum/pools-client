...
export type AuthorizerChangedEvent = TypedEvent<[string] & { newAuthorizer: string }>;
...
export type TokensDeregisteredEvent = TypedEvent<[string, string[]] & { poolId: string; tokens: string[] }>;
...
export class Vault extends BaseContract {
    ...
    filters: {
        ...
        AuthorizerChanged(newAuthorizer?: string | null): TypedEventFilter<[string], { newAuthorizer: string }>;
        ...
        'InternalBalanceChanged(address,address,int256)'(
            ...
            token?: string | null,
            delta?: null,
        ): TypedEventFilter<[string, string, BigNumber], { user: string; token: string; delta: BigNumber }>;
        ...
        'PausedStateChanged(bool)'(paused?: null): TypedEventFilter<[boolean], { paused: boolean }>;

        PausedStateChanged(paused?: null): TypedEventFilter<[boolean], { paused: boolean }>;
        ...
        'PoolRegistered(bytes32,address,uint8)'(
            ...
            specialization?: null,
        ): TypedEventFilter<[string, string, number], { poolId: string; poolAddress: string; specialization: number }>;
        ...
        'RelayerApprovalChanged(address,address,bool)'(
            ...
            sender?: string | null,
            approved?: null,
        ): TypedEventFilter<[string, string, boolean], { relayer: string; sender: string; approved: boolean }>;
