...
export class Pausable extends BaseContract {
    ...
    filters: {
        ...
        'OwnerNominated(address)'(newOwner?: null): TypedEventFilter<[string], { newOwner: string }>;

        OwnerNominated(newOwner?: null): TypedEventFilter<[string], { newOwner: string }>;

        'PauseChanged(bool)'(isPaused?: null): TypedEventFilter<[boolean], { isPaused: boolean }>;

        PauseChanged(isPaused?: null): TypedEventFilter<[boolean], { isPaused: boolean }>;
    };
