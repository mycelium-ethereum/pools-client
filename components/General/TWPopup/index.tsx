        ...
        <Popover as="div" className={className ?? ''}>
            {({ open }) => (
                <>
                    ...
                    >
                        <Popover.Panel className="absolute right-0 z-20 mt-2 origin-top-right rounded-lg bg-theme-background shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                            {children}
                        </Popover.Panel>
                    </Transition>
                </>
