        ...
        <Popover as="div" className={className ?? ''}>
            {({ open }) => (
                <>
                    ...
                    >
                        <Popover.Panel className="origin-top-right absolute z-10 right-0 mt-2 rounded-lg shadow-lg bg-theme-background ring-1 ring-black ring-opacity-5 focus:outline-none">
                            {children}
                        </Popover.Panel>
                    </Transition>
                </>
