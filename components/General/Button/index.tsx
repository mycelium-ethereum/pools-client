...
const VARIANT: Record<ButtonVariant, string> = {
    ...
    primary:
        'bg-tracer-500 matrix:bg-theme-primary matrix:text-theme-background dark:bg-tracer-500 text-white w-full hover:bg-tracer-600 disabled:hover:bg-tracer-500 disabled:opacity-50 focus:ring focus:ring-tracer-300',
    'primary-light':
