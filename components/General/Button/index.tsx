...
const VARIANT: Record<ButtonVariant, string> = {
    ...
    primary:
        'bg-tracer-600 text-white w-full text-high-emphesis hover:bg-tracer-900 disabled:bg-opacity-50 disabled:hover:bg-tracer-600 disabled:hover:opacity-50 focus:ring focus:ring-tracer-300',
    'primary-light':
