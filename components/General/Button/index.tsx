...
const VARIANT: Record<ButtonVariant, string> = {
    ...
    'primary-light':
        'matrix:bg-transparent border border-tracer-500 matrix:border-theme-border text-theme-text w-full hover:bg-opacity-50 dark:hover:bg-opacity-50 matrix:hover:opacity-50 disabled:opacity-50',
    transparent:
