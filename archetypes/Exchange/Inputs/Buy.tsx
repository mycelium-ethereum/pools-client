...
import { LONG, SIDE_MAP } from '@libs/constants';
	...
	return (
		<>
			...
			<InputContainer>
				...
				<Select
					onChange={(e) => swapDispatch({ type: 'setLeverage', value: parseInt(e.currentTarget.value) as LeverageType})}
					disabled={!selectedPool}
				>
	...
	return (
		...
		>	
			<Box>
				...
				<Section label="Expected Token Price">
