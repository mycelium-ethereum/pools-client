 ...
 */
export const getDecimals: (type: CommitEnum, quoteTokenDecimals: number) => number = (type, quoteTokenDecimals) => {
    return type === CommitEnum.long_mint || type === CommitEnum.short_mint ? quoteTokenDecimals : ERC20_CLONEABLE;
};
