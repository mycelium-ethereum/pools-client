...
interface PoolFactoryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "poolCommitterDeployer()": FunctionFragment;
    ...
    "setPoolCommitterDeployer(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "poolCommitterDeployer",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setPoolCommitterDeployer",
    values: [string]
  ): string;
  encodeFunctionData(
...
export class PoolFactory extends BaseContract {
  ...
  functions: {
    ...
    poolCommitterDeployer(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    poolCommitterDeployer(overrides?: CallOverrides): Promise<BigNumber>;
