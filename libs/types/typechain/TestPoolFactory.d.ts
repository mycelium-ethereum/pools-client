...
interface TestPoolFactoryInterface extends ethers.utils.Interface {
  functions: {
    "createPool(string)": FunctionFragment;
  ...
  events: {
    "DeployPool(address)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "DeployPool"): EventFragment;
}

export class TestPoolFactory extends BaseContract {
  ...
  interface: TestPoolFactoryInterface;
  ...
  callStatic: {
    createPool(_poolCode: string, overrides?: CallOverrides): Promise<void>;
